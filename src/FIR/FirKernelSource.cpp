...
#include "FirKernelSourceHelpers.h"
...
FirKernelSource::FirKernelSource(unsigned sampleRate, const std::vector<EnvelopePoint>& points)
{
    ...
    points_ = FirKernelSourceHelpers::NormalizeEnvelopeToGrid(points, sampleRate);
}
